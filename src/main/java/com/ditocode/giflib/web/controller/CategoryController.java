package com.ditocode.giflib.web.controller;

import com.ditocode.giflib.model.Category;
import com.ditocode.giflib.service.CategoryService;
import com.ditocode.giflib.web.Color;
import com.ditocode.giflib.web.FlashMessage;
...
public class CategoryController {
    ...
    public String updateCategory(@Valid Category category, BindingResult result, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("flash", new FlashMessage("Category successfully updatep!", FlashMessage.Status.SUCCESS));
