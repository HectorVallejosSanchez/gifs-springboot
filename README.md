# gif.lib
This application is used in the Spring with Hibernate. The app was originally built in the Spring Basics, and its functionality is extended in the following ways:
